...
func (r *CyborgAPIReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, _err error) {
	...
	ssDef, err := cyborgapi.StatefulSet(instance, inputHash, serviceLabels, topology)
	if err != nil {
		return ctrl.Result{}, err
	}
...
func (r *CyborgAPIReconciler) findObjectsForSrc(ctx context.Context, src client.Object) []reconcile.Request {
	return internalcommon.FindObjectsForSrcByField(
		ctx, r.GetLogger(ctx), r.Client, src,
		apiWatchFields,
		func() client.ObjectList { return &cyborgv1beta1.CyborgAPIList{} },
	)
}
