...
var conductorWatchFields = []string{
...
func (r *CyborgConductorReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, _err error) {
	...
	ssDef, err := cyborgconductor.StatefulSet(instance, inputHash, serviceLabels, topology)
	if err != nil {
		return ctrl.Result{}, err
	}
...
func (r *CyborgConductorReconciler) generateServiceConfig(
	...
	return internalcommon.GenerateConfigs(
		ctx, h, instance,
		internalcommon.GetServiceConfigSecretName(instance.GetName()),
		envVars, templateParameters, customData, serviceLabels,
		map[string]string{"00-default.conf": "/cyborg/00-default.conf"},
		nil, "cyborg/conductor",
	)
}
...
func (r *CyborgConductorReconciler) findObjectsForSrc(ctx context.Context, src client.Object) []reconcile.Request {
	return internalcommon.FindObjectsForSrcByField(
		ctx, r.GetLogger(ctx), r.Client, src,
		conductorWatchFields,
		func() client.ObjectList { return &cyborgv1beta1.CyborgConductorList{} },
	)
}
