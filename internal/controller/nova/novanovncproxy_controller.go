...
func (r *NovaNoVNCProxyReconciler) findObjectsForSrc(ctx context.Context, src client.Object) []reconcile.Request {
	return internalcommon.FindObjectsForSrcByField(
		...
		r.Client,
		src,
		noVNCProxyWatchFields,
		func() *novav1.NovaNoVNCProxyList { return &novav1.NovaNoVNCProxyList{} },
		func(l *novav1.NovaNoVNCProxyList) []novav1.NovaNoVNCProxy { return l.Items },
	)
}
