...
func (r *NovaSchedulerReconciler) findObjectsForSrc(ctx context.Context, src client.Object) []reconcile.Request {
	return internalcommon.FindObjectsForSrcByField(
		...
		r.Client,
		src,
		schedulerWatchFields,
		func() client.ObjectList { return &novav1.NovaSchedulerList{} },
	)
}
...
func (r *NovaSchedulerReconciler) ensureDeployment(
	...
	ssDef, err := novascheduler.StatefulSet(instance, inputHash, serviceLabels, annotations, topology, memcached)
	if err != nil {
		return ctrl.Result{}, err
	}
