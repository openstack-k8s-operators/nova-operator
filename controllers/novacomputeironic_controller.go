...
func (r *NovaComputeIronicReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, _err error) {
	...
	// during NovaComputeIronic CR delete we can have a chance to remove the finalizer from
...
func (r *NovaComputeIronicReconciler) ensureDeployment(
	...
	ss := statefulset.NewStatefulSet(novacomputeironic.StatefulSet(instance, inputHash, getComputeIronicServiceLabels(), annotations), r.RequeueTimeout)
...
func (r *NovaComputeIronicReconciler) ensureServiceExposed(
	ctx context.Context,
	h *helper.Helper,
	instance *novav1.NovaComputeIronic,
) (map[string]string, ctrl.Result, error) {
	var ports = map[endpoint.Endpoint]endpoint.Data{
		endpoint.EndpointPublic:   {Port: novacomputeironic.APIServicePort},
		endpoint.EndpointInternal: {Port: novacomputeironic.APIServicePort},
	}
...
func (r *NovaComputeIronicReconciler) ensureKeystoneEndpoint(
	ctx context.Context,
	h *helper.Helper,
	instance *novav1.NovaComputeIronic,
	...
	endpointSpec := keystonev1.KeystoneEndpointSpec{
		ServiceName: novacomputeironic.ServiceName,
...
func (r *NovaComputeIronicReconciler) ensureKeystoneEndpointDeletion(
	ctx context.Context,
	h *helper.Helper,
	instance *novav1.NovaComputeIronic,
) error {
	...
	endpoint, err := keystonev1.GetKeystoneEndpointWithName(ctx, h, novacomputeironic.ServiceName, instance.Namespace)
	if err != nil && !k8s_errors.IsNotFound(err) {
		return err
	}
...
func getComputeIronicServiceLabels() map[string]string {
