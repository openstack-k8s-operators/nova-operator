...
CLUSTER_BUNDLE_FILE="bundle/manifests/nova-operator.clusterserviceversion.yaml"

echo "Creating nova operator bundle"
cd ..
echo "${GITHUB_SHA}"
echo "${BASE_IMAGE}"
skopeo --version
...
# Output:
# Calculating image digest for docker://quay.io/openstack-k8s-operators/nova-operator:d03f2c1c362c04fc5ef819f92a218f9ea59bbd0c
