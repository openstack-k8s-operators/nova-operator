...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.3.1-0.20240227073850-ffd41379d759
	github.com/openstack-k8s-operators/lib-common/modules/test v0.3.1-0.20240227073850-ffd41379d759
