...
replace github.com/openstack-k8s-operators/lib-common/modules/common => github.com/bshephar/lib-common/modules/common v0.0.0-20240214130317-80f648832f68

replace github.com/openstack-k8s-operators/lib-common/modules/openstack => github.com/bshephar/lib-common/modules/openstack v0.0.0-20240214130317-80f648832f68

replace github.com/openstack-k8s-operators/lib-common/modules/test => github.com/bshephar/lib-common/modules/test v0.0.0-20240214130317-80f648832f68

// bshephar:controller-runtime-v16
replace github.com/openstack-k8s-operators/infra-operator/apis => github.com/bshephar/infra-operator/apis v0.0.0-20240214123229-e7b54f7152c4

//bshephar:controller-runtime
replace github.com/openstack-k8s-operators/keystone-operator/api => github.com/bshephar/keystone-operator/api v0.0.0-20240214131401-e55b98626ce1

//bshephar:controller-runtime
replace github.com/openstack-k8s-operators/mariadb-operator/api => github.com/bshephar/mariadb-operator/api v0.0.0-20240214125320-2f2408943251
