...
// mbayer: DNM just testing
replace github.com/openstack-k8s-operators/mariadb-operator/api => github.com/zzzeek/mariadb-operator/api v0.3.1-0.20240222182740-647dde5e6717 //allow-merging
