...
func ScriptsConfigMap(cr *novav1beta1.Nova, scheme *runtime.Scheme, log logr.Logger) *corev1.ConfigMap {
...
func ConfigMap(cr *novav1beta1.Nova, scheme *runtime.Scheme) *corev1.ConfigMap {
	opts := novaConfigOptions{"FIXME"}
...
func CustomConfigMap(cr *novav1beta1.Nova, scheme *runtime.Scheme) *corev1.ConfigMap {
