...
require (
	...
	github.com/openstack-k8s-operators/keystone-operator/api v0.3.1-0.20240429064045-7c2a9826c3cd
	...
	github.com/openstack-k8s-operators/mariadb-operator/api v0.3.1-0.20240429052630-ecfd113a155d
