...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/test v0.3.1-0.20231204114424-a857120974fc
...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.3.1-0.20231204114424-a857120974fc //indirect
