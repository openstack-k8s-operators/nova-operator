...
import (
	...
	"github.com/openstack-k8s-operators/placement-operator/internal/controller"
	webhookv1beta1 "github.com/openstack-k8s-operators/placement-operator/internal/webhook/v1beta1"
...
func main() {
	...
	if err := (&controller.PlacementAPIReconciler{
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1beta1.SetupPlacementAPIWebhookWithManager(mgr); err != nil {
