...
const (
	...
	//NovaCellsDeketionCondition indicates that the NovaCells deletion is in progress
...
const (
	...
	NovaCellsDeletionConditionReadyMessage = "There is no more NovaCells to delet"
)
