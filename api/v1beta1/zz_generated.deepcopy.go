...
func (in *NovaComputeSpec) DeepCopyInto(out *NovaComputeSpec) {
	*out = *in
	if in.PassthroughWhitelist != nil {
		in, out := &in.PassthroughWhitelist, &out.PassthroughWhitelist
		*out = make([]PciPassthrough, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PciPassthrough) DeepCopyInto(out *PciPassthrough) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PciPassthrough.
func (in *PciPassthrough) DeepCopy() *PciPassthrough {
	if in == nil {
		return nil
	}
	out := new(PciPassthrough)
	in.DeepCopyInto(out)
	return out
}
