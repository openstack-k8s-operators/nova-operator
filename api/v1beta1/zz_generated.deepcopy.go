...
func (in *NovaSpec) DeepCopyInto(out *NovaSpec) {
	*out = *in
	if in.KeystoneServiceSelector != nil {
		in, out := &in.KeystoneServiceSelector, &out.KeystoneServiceSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.APIDBSelector != nil {
		in, out := &in.APIDBSelector, &out.APIDBSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.APIMessageBusSelector != nil {
		in, out := &in.APIMessageBusSelector, &out.APIMessageBusSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	...
	if in.CellTemplates != nil {
		...
		*out = make(map[string]NovaCellSpec, len(*in))
		for key, val := range *in {
