...
// ConductorOverrideSpec to override the generated manifest of several child resources.
type ConductorOverrideSpec struct {
...
type CyborgConductorTemplate struct {
	...
	Override ConductorOverrideSpec `json:"override,omitempty"`
}
