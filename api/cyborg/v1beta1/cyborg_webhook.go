...
func (images *CyborgImages) Default(defaults CyborgDefaults) {
	if images.APIContainerImageURL == "" {
		images.APIContainerImageURL = defaults.APIContainerImageURL
	}
	if images.ConductorContainerImageURL == "" {
		images.ConductorContainerImageURL = defaults.ConductorContainerImageURL
	}
	if images.AgentContainerImageURL == "" {
		images.AgentContainerImageURL = defaults.AgentContainerImageURL
	}
}
...
func (spec *CyborgSpecCore) ValidateConductorServiceTemplate(basePath *field.Path, namespace string) field.ErrorList {
	...
	errors = append(errors,
		spec.ConductorServiceTemplate.Override.Probes.ValidateProbes(
			basePath.Child("conductorServiceTemplate").Child("override").Child("probes"))...)
